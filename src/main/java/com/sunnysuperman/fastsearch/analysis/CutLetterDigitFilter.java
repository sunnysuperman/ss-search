...
// (TermAttribute)input.getAttribute(TermAttribute.class);
// OffsetAttribute offsetAtt =
// (OffsetAttribute)input.getAttribute(OffsetAttribute.class);
// TypeAttribute typeAtt =
// (TypeAttribute)input.getAttribute(TypeAttribute.class);
//
// nextToken = reusableToken.reinit(termAtt.termBuffer(), 0,
// termAtt.termLength(), offsetAtt.startOffset(), offsetAtt.endOffset(),
// typeAtt.type());*/
//
...
// }
//
// private void addToken(Token oriToken, int termBufferOffset, int
// termBufferLength, byte type) {
